<div id="ae-bar" class="clearfix">
  ...
  <ul id="ae-sidemenu">
    ...
    <li id="ae-sidemenu-for-help"><a class="tooltipped" title="Get Support or view the documentation" href="<?php print variable_get('campaignion_support_link', 'https://support.more-onion.com'); ?>">Help & support</a></li>
